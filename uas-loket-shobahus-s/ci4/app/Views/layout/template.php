...
<head>
  ...
  <link rel="icon" href="<https://pngimage.net/wp-content/uploads/2018/06/logo-rumah-sakit-png-7.png">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon rotate-n-1">
          ...
          <i class="fas"><img class="fas" height="40px" src="https://pngimage.net/wp-content/uploads/2018/06/logo-rumah-sakit-png-7.png"></i>
        </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy;Shobahus S <?= date('Y') ?></span>
